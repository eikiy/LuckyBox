...
public class blSuggestCard
{
    ...
    public static void BindStore(DropDownList ddl, string strStoreNo)
    {
        ...
        DS = DBSuggestCard_BindStore.Sel_StoreViewTest(strStoreNo, out sReturnMsg);
    ...
    public static void BindTime(DropDownList dropTime, string strStoreNo)
    {
        ...
        string sReturnMsg = "";
        DataSet DS = new DataSet();
        DS = DBSuggestCard_BindTime.Sel_SC_ParameterItemsTest(strStoreNo, out sReturnMsg);
    ...
    {
        return DBSuggestCard.InsertSC_ProductSugguest(sProdSugGUID, sRecMainGUID, sAnsGUID, sAnsName, sSugNote, sCareerNo, siType);
    }
