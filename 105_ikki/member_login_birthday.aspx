<%@ Page Language="C#" AutoEventWireup="true" CodeFile="member_login_birthday.aspx.cs" Inherits="member_login_birthday" %>
...
<div class="content">
	...
	<div class="word">
      ...
      <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td style="border:none;">祝您生日快樂！ 請登入您的帳號及密碼~即可下載專屬兌換券！</td>
            </tr>
      </table>
      <table border="0" cellpadding="0" cellspacing="0">
      </table>
      ...
      <td colspan="2" ><font face="新細明體">
                                        <asp:TextBox id="txtEmail"  class="member_inputtxt" runat="server" Width="226px"></asp:TextBox>
                                    </font></td>
      </tr>
    <tr>
      <td class="font_04">▍密碼</td>
      <td colspan="2">
                                        <asp:TextBox id="txtPwd" runat="server"  class="member_inputtxt" Width="128px" TextMode="Password" MaxLength="20"></asp:TextBox>                                        4 - 8 個字元
                                    </td>
    </tr>
        <tr>
        ...
        <asp:ImageButton 
            ID="ImageButton1" runat="server" ImageUrl="images/submit.png"  
