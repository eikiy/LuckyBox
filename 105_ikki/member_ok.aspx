        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td style="border:none;">
                    <asp:Label ID="lblName" runat="server" Text="Label"></asp:Label>貴賓您好：<br>您的會員認證資料已發送到<asp:Label ID="labEmail" runat="server" CssClass="coffee12"></asp:Label> 這個信箱. <br>
         請至此 email 信箱確認成為 藝奇 的網路會員，並列印入會禮。謝謝。</td>
            </tr>
      </table>
      <table border="0" cellpadding="0" cellspacing="0" style="margin-top:-20px;">
            <tr>
              <td colspan="2" class="font_02">是否一直沒收到確認信函？</td>
        </tr>
            <tr>
              <td width="4%">．</td>
              <td>首先建議您再稍候片刻，信件會因應網路品質影響您收信的時間。 </td>
            </tr>
            <tr>
              <td width="4%">．</td>
              <td>倘若您一直沒收到確認信函，建議您可檢查您的 email 是否有錯誤。<br>
                若發現任何錯誤,可再重新註冊一次即可。</td>
            </tr>
            <tr>
              <td width="4%">．</td>
              <td>建議您可檢查郵件信箱的垃圾郵件夾，檢查是否有 藝奇 的註冊確認信函。</td>
            </tr>
            <tr>
              <td width="4%">．</td>
              <td>若您一直無法收到確認信函，歡迎您可填寫 <a href="mailto:service@ikki.com.tw"> 客服信箱</a> </span> 或 <br>
                              撥打免付費意見專線<span class="font01"> 0800-365-000 </span>為您處理。 </td>
            </tr>
      </table>
    <img src="event/images/13_app_ik_member.gif" width="550" height="200" class="banner" style=" margin-left:60px;">
    </div>	
</div>
