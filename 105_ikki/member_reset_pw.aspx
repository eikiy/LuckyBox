...
<div class="content">
	...
	<div class="word">
      ...
      <img src="images/icon_member_07.png" width="630" height="45">
      
      <table border="0" cellpadding="0" cellspacing="0">
      </table>
      <table border="0" cellpadding="0" cellspacing="0" style="margin-top:-20px;">
      <tr>
      <td width="25%" class="font_04">▍新密碼：</td>
      <td colspan="2" >
      <%--<input name="textfield" type="text" class="member_inputtxt" id="textfield" maxlength="20"> --%>
      ...
      <tr>
      <td class="font_04">▍請再輸入一次：</td>
      <td colspan="2" >
      <%--<input name="textfield2" type="text" class="member_inputtxt" id="textfield2" maxlength="20"> --%>
    ...
    alt="" width="285" height="51" style="cursor:pointer; border: none;" />
    </a>--%>
