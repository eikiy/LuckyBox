<%@ Page Language="C#" AutoEventWireup="true" CodeFile="member_edit_success.aspx.cs" Inherits="member_edit_success" %>
...
<div class="content">
	...
	<div class="word">
      ...
      <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td style="border:none;"><asp:Label id="LiteName" runat="server"></asp:Label>貴賓您好：<br>
                您已經成功啟用您的 email 帳號。感謝您對 藝奇 的愛護與支持~</td>
        </tr>
      </table>
