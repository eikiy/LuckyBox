<%@ Page Language="C#" AutoEventWireup="true" CodeFile="member_birthday_print.aspx.cs" Inherits="member_birthday_print" %>
...
<body>
<div class="wrapper"><div class="logo"><a href="/index-1.html"><img src="images/logo.png" width="231" height="114"></a></div>
<!--<div class="header"> 
	...
	<div class="word">
      ...
      <img src="images/icon_member_01.png" width="630" height="45">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td style="border:none;"> <asp:Label id="lblCName" runat="server"></asp:Label> 貴賓 您好：<br><Br>
  藝奇 祝您 生日快樂~<BR>  您可以列印此兌換券，憑本券至 藝奇 消費，即可免費兌換生日好禮。</td>
            </tr>
      </table>
          <!--coupon內容-->
          <div style="margin-left:60px;">
            <div style="position:relative; width:500px; height:250px; z-index:9990;">
                        <div style="position: absolute; top: 11px; left: 33px; z-index: 8999;">網路生日禮</div>
              <div style="position:absolute; top:165px; left:45px; z-index:8998;" class="qrcode_14"><asp:Literal ID="LiteNO" runat="server"></asp:Literal></div>
                        ...
                        <div style="position: absolute; top: 25px; left: 198px; z-index: 8996;">這是給  <asp:Literal ID="LiteName2" runat="server"></asp:Literal> 的</div>
              <div style="position: absolute; top: 141px; left: 283px; z-index: 8997;"><asp:Literal ID="LiteDate" runat="server"></asp:Literal></div>
            <img src="event/images/birthday_coupon.jpg" width="500" height="230" style="z-index:1;" class="banner"/></div><br>
           
           </div>
           <!--coupon內容  end-->
           <!--<div style="margin:5px 0 20px 75px;"><img src="event/images/birthday_201503plus.jpg" width="500" height="680"></div>-->
