<%@ Page Language="C#" AutoEventWireup="true" CodeFile="books.aspx.cs" Inherits="event_13_design_books"  ResponseEncoding="utf-8"  %>
...
<body>
<div style="position:absolute; top:200px; left:50%; margin-left:-325px;"><img src="images/ending.png" width="610" height="485"></div>
...
<table border="0" cellpadding="0" cellspacing="0" style="background:url(images/13_design_login_11.jpg); height:123px;">
    	<tr>
        	<td width="505">&nbsp;</td>
            <td style="color:#fff; padding-bottom:15px;">剩餘名額 <asp:Label runat="server" ID="lblCnt"></asp:Label> 名</td>
        </tr>
  </table>
    	...
    	<tr>
        	<td width="17%" height="10" align="right">&nbsp;</td>
        	    <td width="16%" >&nbsp;</td>
       	      ...
       	      <%--<IFRAME id="iframe1" width="200"  height="120"  name="iframe1" src="../../CheckImageCode.aspx" frameBorder="0"
									runat="server"></IFRAME>  --%>
                     &nbsp;<%--   <a href="books_ok.aspx">
              <img src="images/btn_login.png" onmouseover="this.src='images/btn_logina.png'" onmouseout="this.src='images/btn_login.png'" alt="" width="74" height="21" style="cursor:pointer; border: none;" />
              </a>--%></td>
      </tr>
       	    <tr>
...
<%--        	<tr>
            	<td align="right"><font color="#ff0000">▌</font>請輸入驗證碼 :</td>
                <td><label>
                    <asp:TextBox runat="Server" ID="txtCheckCode"   Width="150px"></asp:TextBox>
                </label></td>
            </tr>            --%>
            <tr>
              <td></td>
            ...
            <tr>
            	<td colspan="3" style="padding-left:100px;">參加活動前，請先 <a href="http://www.ikki.com.tw/member_join.aspx" target="_blank">加入網路會員</a> ，謝謝！<br>當您關閉此分頁時，您的會員資料將自動完成登出。謝謝~</td>
        </tr>
    </table>
    </div>
  ...
  <div class="footer">
    ...
    <div class="link">
        <img src="images/footer_19.jpg" border="0" usemap="#Map2">
          ...
          <area shape="rect" coords="169,77,307,138" href="http://www.larche100.org/" target="_blank">
