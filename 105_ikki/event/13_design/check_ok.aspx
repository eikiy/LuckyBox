<%@ Page Language="C#" AutoEventWireup="true" CodeFile="check_ok.aspx.cs" Inherits="event_13_design_check_ok" %>
...
<div class="wrapper">
  <table border="0" cellpadding="0" cellspacing="0">
	...
	<img src="images/13_design_check_ok_11.jpg">
    </table>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="height:187px;" class="login-bg">
            ...
            <tr>
            	<td style="padding-left:80px; font-size:16px; line-height:30px; "> <asp:Label runat="server" ID="lblCName"></asp:Label>   貴賓您好，您的博客來E-Coupon折價券50元(兩組25元)
                <br>
