...
public partial class event_14_summer_login : System.Web.UI.Page
{
    Sql s = new Sql();
    Public p = new Public();
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["201404_371PrintName"] = DS.Tables[0].Rows[0]["姓名"].ToString().Trim();
        Response.Redirect("login_ok.aspx");
        //this.RegisterStartupScript(Guid.NewGuid().ToString(), "<script>window.location.href='share_ok.aspx';</script>");
    }
}
