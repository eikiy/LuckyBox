...
-->
	...
	<body bgcolor="#000000" leftmargin="0" topmargin="0">
		<form id="Form1" name="form1" method="post" action="" runat="server">
			<table width="990" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#000000">
				<tr>
					<td><table border="0" align="center" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td><img src="images/page_04.jpg" width="296" height="431"></td>
								<td bgcolor="#f3f3f3">
...
為了提供您後續商品電話服務，於您按下「送出」時，您於上列所填寫的資料將會送予花旗銀行，由花旗銀行人員與您聯絡。花旗銀行必將以「花旗（台灣）銀行集團全球客戶隱私保護承諾」保護您個人資料安全，且於法令許可及行銷饗樂生活卡目的範圍內，在國內外蒐集、處理、利用您的個人資料。若您同意前述聲明且已詳閱並同意花旗銀行「<a href="http://www.citibank.com.tw/global_docs/chi/pressroom/infoprotect.pdf">蒐集、處理及利用個人資料告知事項</a>」
											<table width="100%" border="0" cellpadding="3" cellspacing="2">
													  <tr bgcolor="#ebebeb">
														...
														<tr bgcolor="#ebebeb">
															...
															<td>（O） <input type="text" name="textfield2" id="txtOfficePhone" runat="server"> （H）
																<input type="text" name="textfield4" id="txtHomePhone" runat="server"></td>
														</tr>
														<tr bgcolor="#ebebeb">
															<td>（手機） <input type="text" name="textfield3" class="AmountInputLimit" id="txtMobile" maxLength="10"
																	runat="server"></td>
														</tr>
														<tr bgcolor="#ebebeb">
							...
							<tr>
								<td colspan="3"><table width="976" border="0" cellspacing="0" cellpadding="0">
								  <tr>
								    <td width="220">&nbsp;</td>
								    <td><iframe 
