...
<div class="content">
	...
	<div class="word">
      ...
      <td colspan="2" ><asp:TextBox ID="email" runat="server" CssClass="member_inputtxt" 
                          MaxLength="80"></asp:TextBox></td>
      </tr>
      <tr>
      <td width="20%" class="font_04">▍請輸入驗證碼<br>(不分大小寫)</td>
      <td colspan="2" >
          <asp:TextBox ID="code" runat="server" CssClass="member_year" MaxLength="5" Width="50px"></asp:TextBox>
