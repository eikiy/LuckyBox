<%@ Page Language="C#" AutoEventWireup="true" CodeFile="talk_ok.aspx.cs" Inherits="en_talk_ok" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="word">
        	<tr>
   		  ...
   		  <table width="92%" cellpadding="0" cellspacing="0" class="talk_all">
                            <tr>
                              <td width="105%" class="f_01" style="padding-bottom:20px;">Thank you for your message!! <BR>
                  We hope to see you soon and have great   experiences <br>
                  in our restaurant.</td>
                              </tr>
         </table>
   		  		<br>
           		<br>
