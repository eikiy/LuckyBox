...
<div class="content">
	...
	<div class="word">
      ...
      <img src="images/icon_member_05.png" width="630" height="45">
      <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td style="border:none;">請輸入帳號，我們將回覆【密碼重設通知信】到您 email 信箱中。</td>
            </tr>
      </table>
      <table border="0" cellpadding="0" cellspacing="0">
      </table>
      <table border="0" cellpadding="0" cellspacing="0" style="margin-top:-20px;">
        <tr>
      <td width="25%" class="font_04">▍email 帳號</td>
      <td colspan="2" ><asp:TextBox ID="txtEmail" runat="server" CssClass="member_inputtxt" 
                          MaxLength="80"></asp:TextBox></td>
      </tr>
      <tr>
      <td width="20%" class="font_04">▍請輸入驗證碼<br>(不分大小寫)</td>
      <td colspan="2" >
          <asp:TextBox ID="code" runat="server" CssClass="member_year" MaxLength="5" Width="70px"></asp:TextBox>
          <iframe name="imgcode" id="imgcode" src="m/code.aspx" width="120" height="50" scrolling="no" frameborder="0"></iframe>
          <a href="javascript:;" onclick="document.getElementById('imgcode').contentWindow.location.reload();" class="member_g1">&larr;更換別組圖示</a></td>
      </tr>
    </table>
