...
<div class="content">
  ...
  藝奇 祝您 結婚紀念日快樂~<BR>  您可以列印此兌換券，憑本券至 藝奇 消費，即可免費兌換結婚好禮。</td>
            </tr>
      </table>
          <!--coupon內容-->
          <div style="margin-left:60px;">
            <div style="position:relative; width:500px; height:250px; z-index:9990;">
                        <div style="position:absolute; top:10px; left:45px; z-index:8999;">網路結婚禮</div>
                        ...
                        <div style="position:absolute; top:25px; left:220px; z-index:8996;">這是給 <asp:Literal ID="LiteName2" runat="server"></asp:Literal> 貴賓的</div>
