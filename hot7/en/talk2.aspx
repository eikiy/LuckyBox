    ...
    <div class="container" style="clear:both;">
      ...
      <div class="word" style="margin-top:180px; padding-bottom:30px;">      
        ...
        <table width="95%" border="0" cellpadding="5" cellspacing="0" class="x_tb">
          ...
          <tr>
                <td class="x_f04a">We appreciate you visiting our website. If you have further question, please leave your WWWmessage as below. We will get back to you as soon as we can if necessary.<br>
   	...
   	<table width="95%" border="0" cellpadding="5" cellspacing="0" class="x_tb">
              ...
              <tr>
                ...
                <td>
                  <input type="radio" name="radio" id="radio" value="radio">Male　<input type="radio" name="radio" id="radio" value="radio">Female
                </td>
              </tr>
               <tr>
                <td colspan="2" class="x_line"></td>
              ...
              <tr>
                ...
                Mobile No.</td>
                <td><input name="" type="text"> e.g.0910123456 or 0212345678</td>
              </tr>
               <tr>
                <td colspan="2" class="x_line"></td>
              </tr>
              ...
              <tr>
                ...
                <a href="talk_ok.aspx"><img src="images/btn_check.png" onmouseover="this.src='images/btn_checka.png'" onmouseout="this.src='images/btn_check.png'" alt="" width="150" height="45" style="cursor:pointer; border: none;" /></a>
                </td>
          </tr>
          </table>
        </div>
