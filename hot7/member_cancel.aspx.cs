...
public partial class member_cancel : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
       if (txtEmail.Text.Trim() == "")
        ...
        //int res = wow.Wow_MemberLoginCheck(aaclsPubSet.strP_ShopNo, txtEmail.Text.Trim(), txtPwd.Text.Trim());
        ...
        sError = wow.Wow_MemberCancelAllEdm(aaclsPubSet.strP_ShopNo, "", txtEmail.Text.Trim());
        if (sError != "")
        {
