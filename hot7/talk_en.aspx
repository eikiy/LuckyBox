<%@ Page Language="C#" AutoEventWireup="true" CodeFile="talk_en.aspx.cs" Inherits="talk_en" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">



<html lang="en"><!-- InstanceBegin template="/Templates/hot7_en.dwt" codeOutsideHTMLIsLocked="false" -->
  <!--<![endif]-->
  <head>
...
<script>
  ...
  <form id="form2" runat="server">
    ...
    <div class="wide_layout bg_light">
            ...
            <div class="row">
              ...
              <ul class="hr_list main_menu type_2 fw_normal t_align_l ">
                <li class="container3d relative f_xs_none m_xs_bottom_5 ">
                  <a class="color_green relative r_xs_corners border_none p_tb_7" href="#">English<i class="icon-angle-down d_inline_m"></i></a>
          ...
          <div class="container t_align_c">
            ...
            <nav role="navigation" class="d_inline_m d_xs_none m_xs_right_0 m_right_15 m_sm_right_5 t_align_l m_xs_bottom_15">
              <ul class="hr_list main_menu type_2 fw_normal">
                <li class="container3d relative f_xs_none m_xs_bottom_5">
                  <a class="color_light fs_large relative r_xs_corners" href="menu_en.html">MENU
                    <i class="icon-angle-down d_inline_m"></i></a>
                </li>
                <li class="container3d relative f_xs_none m_xs_bottom_5">
                  <a class="color_light fs_large relative r_xs_corners" href="#">BRANCHES
                    <i class="icon-angle-down d_inline_m"></i></a>
                  <ul class="sub_menu r_xs_corners bg_light vr_list tr_all tr_xs_none trf_xs_none bs_xs_none d_xs_none">
                    <li>
                    <a href="store1_en.html" class="d_block color_grey relative">North Taiwan</a>
                </li>
                <li>
                <a href="store2_en.html" class="d_block color_grey relative">Central Taiwan</a>
                </li>
                <li>
                <a href="store3_en.html" class="d_block color_grey relative">South Taiwan</a>
                </li>
              </ul>
              </li>
              <li class="container3d relative f_xs_none m_xs_bottom_5 ">
                <a class="color_light fs_large relative r_xs_corners" href="talk_en.html">CONTACT US
                  <i class="icon-angle-down d_inline_m"></i></a>
              </li>
              </ul>
            </nav>
      ...
      <!--header image-->
      <section class="image_bg_8 darkness type_4 relative m_bottom_0">
        <div class="container">
          <div class="d_table_cell d_xs_block">
            <div class="col-lg-6 col-md-6 col-sm-6 f_none d_table_cell v_align_m d_xs_block m_xs_bottom_30 form_description">
              <h3 class="fw_light color_light m_bottom_25">Hi, My friend ：</h3>
              <p class="m_bottom_30 color_grey_light_3">We appreciate you visiting our website. If you have further question, please leave your message as below. We will get back to you as soon as we can if necessary.
                <br>					 (All column should be filled)
              </p>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 f_none d_table_cell v_align_m d_xs_block t_align_c">
                ...
                <form id="form_1" >
                  <ul>
                    <li class="m_bottom_10 m_xs_bottom_15 relative">
                      ...
                      <%--<input type="text" name="" placeholder="Your Name" class="r_corners bg_light w_full border_none">--%>
                      <asp:TextBox ID="name" runat="server" placeholder="Your Name" CssClass="r_corners bg_light w_full border_none"></asp:TextBox>
                    </li>
                    <li class="m_bottom_10 m_xs_bottom_15 relative color_light t_align_l">
                      <label class="d_inline_m d_sm_block w_sm_auto m_sm_bottom_5">Gender
                      </label>
                      <%--<input type="radio" checked id="radio_1" name="radio" class="d_none">
                      <label for="radio_1" class="d_inline_m m_right_10">Male
                      </label>
                      <input type="radio" id="radio_2" name="radio" class="d_none">
                      <label for="radio_2" class="d_inline_m m_right_10">Female
                      </label>--%>
                      
                      <asp:RadioButtonList ID="RadioButtonList_Gender" runat="server" RepeatDirection="Horizontal">
                            
                        <asp:ListItem Value="man" Selected=True>
                        <label for="radio_1" >Male
                        </label></asp:ListItem>
                        
                        <asp:ListItem Value="woman">
                        <label for="radio_2">Female
                        </label></asp:ListItem>
                        </asp:RadioButtonList>
                    ...
                    <li class="m_bottom_10 m_xs_bottom_15 relative">
                      <i class="icon-phone login_icon fs_medium color_grey_light_2"></i>
                      <%--<input type="text" name="" placeholder="Phone No. or Mobile No." class="r_corners bg_light w_full border_none">--%>
                      <asp:TextBox ID="mobile" runat="server" CssClass="r_corners bg_light w_full border_none"  placeholder="Phone No. or Mobile No." MaxLength="10"></asp:TextBox>
                    </li>
                    <li class="m_bottom_10 m_xs_bottom_15 relative t_align_l z999">
                      <div class="custom_select r_corners bg_light border_none">
                          ...
                          <%--<select class="d_none" form="form_1">
                              <option value="台北長安東">台北長安東</option>
                              <option value="金典綠園道">金典綠園道</option>
                              <option value="Option 3">Option 3</option>
                          </select>--%>
                          <asp:DropDownList ID="store" runat="server" CssClass="d_none">
                          </asp:DropDownList>
                          
                      </div>
                    </li>
                    <li class="m_bottom_10 m_xs_bottom_15 relative">
                      <i class="icon-chat login_icon fs_medium color_grey_light_2"></i>
                      <%--<input type="text" name="" placeholder="Subject" class="r_corners bg_light w_full border_none">--%>
                      <asp:TextBox ID="subject" runat="server" CssClass="r_corners bg_light w_full border_none" MaxLength="100" placeholder="Subject"></asp:TextBox>
                    </li>
                    <li class="m_bottom_10 m_xs_bottom_15 relative">
                     <%--<textarea name="textarea" rows="" id="textarea" placeholder="Suggestions" class="r_corners bg_light w_full border_none"
                                             style="height:100px;"></textarea>--%>
                      <asp:TextBox ID="content" runat="server"  CssClass="r_corners bg_light w_full border_none" 
                         style="height:100px;" TextMode="MultiLine" placeholder="Suggestions"></asp:TextBox>  
                    </li>
                    <li class="t_align_c">
                      <%--<button class="button_type_3 d_inline_b color_red r_corners tr_all fw_light">SUMIT
                      </button>--%>
                      <asp:Button ID="Button1" runat="server"  class="button_type_3 d_inline_b color_red r_corners tr_all fw_light" text="SUMIT" 
      ...
      <!--content-->
      <section class="section_offset bg_wood">
      </section>
      <!-- InstanceEndEditable -->
      <!--footer-->
                ...
                <div class="row t_align_l m_left_55">
                  <ul class="fw_normal w_break m_xs_bottom_8">
                    <li class="m_bottom_8 f_left m_right_10">
                      ...
                      <a class="color_light fs_large relative jackbox" href="token_ch.html" data-group="token" data-title="">
                    ...
                    <li class="m_bottom_8 f_left m_right_10">
                      ...
                      <li class="m_bottom_8 f_left m_right_10">
                        ...
                        <a href="http://www.wowprime.com/event/app/award.html" target="_blank" class="color_black">瘋美食　　</a>
                      </li>
                      <li class="m_bottom_8 f_left m_right_10">
                        <div class="d_inline_m icon_wrap_size_2 icon_color circle m_right_5">
