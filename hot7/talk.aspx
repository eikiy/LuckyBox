        ...
        <section class="sticky_part bg_red">
          <div class="container t_align_c">
            ...
            <nav role="navigation" class="d_inline_m d_xs_none m_xs_right_0 m_right_15 m_sm_right_5 t_align_l m_xs_bottom_15">
              ...
              <li>
              <a href="store3.aspx" class="d_block color_grey relative">高屏</a>
              </li>
              </ul>
              </li>
              <li class="container3d relative f_xs_none m_xs_bottom_5">
...
<!-- End Google Tag Manager -->
      ...
      <section class="image_bg_8 darkness type_4 relative m_bottom_0">
        <div class="container">
          <div class=" d_xs_block">
            <div class="col-lg-6 col-md-6 col-sm-6 f_none d_table_cell v_align_m d_xs_block ">
              <div class=" m_left_100 m_md_left_0 m_xs_left_0">
               <h3 class="fw_light color_light m_bottom_25">&nbsp;</h3>
                <p class="m_bottom_30 color_grey_light_3"><span class="fw_light color_light m_bottom_25">
				<!--<span style="background:#f00;">親愛的顧客您好：<br />客服於4/4～4/7連續假期暫停服務，<br />各分店營業狀況，請撥打分店專線查詢。謝謝～</span><br><br />-->
                Hi, My friend ：</span><br />
                  您的意見對我們相當重要！ 謝謝您的支持與鼓勵！
                  <br> hot 7 所有的努力，都是為了要提供您更舒適的用餐環境，<br>
                  更美味的食物！ <br> 請您填寫正確連絡資料，<br>
                我們將盡快以e-mail或電話方式與您聯繫，謝謝！</p>
              </div>
            </div>
            <div class="col-lg-5 col-md-5 col-sm-5 f_none d_table_cell v_align_m d_xs_block t_align_r">
                ...
                <form id="form_1" >
                  <ul>
                    <li class="m_bottom_10 m_xs_bottom_15 relative">
                      ...
                      <%--<input type="text" name="" placeholder="姓名" class="r_corners bg_light w_full border_none">--%>
                      <asp:TextBox ID="name" runat="server" placeholder="姓名" CssClass="r_corners bg_light w_full border_none"></asp:TextBox>
                    </li>
                    <li class="m_bottom_10 m_xs_bottom_15 relative color_light t_align_l">
                      <label class="d_inline_m d_sm_block w_sm_auto m_sm_bottom_5">性別
                      </label>
                      <%--<input type="radio" checked id="radio_1" name="radio" class="d_none">
                      <label for="radio_1" class="d_inline_m m_right_10">男
                      </label>
                      <input type="radio" id="radio_2" name="radio" class="d_none">
                      <label for="radio_2" class="d_inline_m m_right_10">女
                      </label>--%>
                    ...
                    <li class="m_bottom_10 m_xs_bottom_15 relative">
                      ...
                      <%--<input type="text" name="" placeholder="電話" class="r_corners bg_light w_full border_none">--%>
                      <asp:TextBox ID="mobile" runat="server" CssClass="r_corners bg_light w_full border_none"  placeholder="電話" MaxLength="10"></asp:TextBox>
                    </li>
                    
                    <li class="m_bottom_10 m_xs_bottom_15 relative">
                      
                      <%--<i class="icon-phone login_icon fs_medium color_grey_light_2"></i><input type="text" name="" placeholder="電話" class="r_corners bg_light w_full border_none">--%>
                      <asp:TextBox ID="email" runat="server" CssClass="r_corners bg_light w_full border_none"  placeholder="email"></asp:TextBox>
                    </li>
                    
                    
                    <li class="m_bottom_10 m_xs_bottom_15 relative t_align_l z999">
                      <div class="custom_select r_corners bg_light border_none">
                          <div class="select_title r_corners  color_grey">消費店別</div>
                    ...
                    <li class="m_bottom_10 m_xs_bottom_15 relative">
                      ...
                      <%--<input type="text" name="" placeholder="主題" class="r_corners bg_light w_full border_none">--%>
                      <asp:TextBox ID="subject" runat="server" CssClass="r_corners bg_light w_full border_none" MaxLength="100" placeholder="主題"></asp:TextBox>
                    </li>
                    <li class="m_bottom_10 m_xs_bottom_15 relative">
                      <%--<textarea name="textarea" rows="" id="textarea" placeholder="內容" class="r_corners bg_light w_full border_none"
                                             style="height:100px;"></textarea>--%>
                       <asp:TextBox ID="content" runat="server"  CssClass="r_corners bg_light w_full border_none" 
                         style="height:100px;" TextMode="MultiLine" placeholder="內容"></asp:TextBox>                      
                    </li>
                    <li class="t_align_c">
                      <%--<button class="button_type_3 d_inline_b color_red r_corners tr_all fw_light"> 送 出
                      </button>--%>
                      <asp:Button ID="Button1" runat="server"  class="button_type_3 d_inline_b color_red r_corners tr_all fw_light" text="送 出" 
