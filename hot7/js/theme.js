				...
				if($(pluginsCollection[4]).length){
					...
					var follow = $(pluginsCollection[4]).next('.tw_follow'),
						config = {
							...
							template : '<li class="fw_light relative m_bottom_25 w_break"><div class="icon_wrap_size_1 color_green circle"><i class="icon-twitter fs_small"></i></div><p>{text}</p><p class="fs_medium color_grey"><i>{time}</i></p></li>'
						}
					...
					var carousel = $(pluginsCollection[8]),
						...
						carousel.flexslider({
							...
							start: function(){
								...
								button.addClass('d_block icon_wrap_size_5 circle color_grey_light tr_all color_green_hover');
