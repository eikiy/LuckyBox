...
public partial class member_edit : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (IsPostBack)
        {
            ...
            //{
            //    Response.Write("<script language=javascript>alert('欄位未填寫完整!!');location.href='member_edit.aspx';</script>");
            //    Response.End();
            //}
            ...
            {
                Response.Write("<script language=javascript>alert('密碼確認錯誤!!');location.href='member_edit.aspx';</script>");
                Response.End();
            }
            #endregion
            ...
            int res = wow.Wow_MemberModify2(CareerNo, dt2, WebSiteUrl, out tMsg);
            if (res == 0)
            {
