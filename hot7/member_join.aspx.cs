...
public partial class member_join : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //餵入資料:115,資料,p,http://www.putien.com.tw/register_success.aspx,
        ...
        if (res == 0)
        {
            ...
            Response.Redirect("member_ok.aspx", false);
            //Response.End();
    ...
    private void SendMail(string errMsg)
    {
        try
        {
            ...
            mail.From = new MailAddress(Public.strP_EMail, Public.strP_Ename + " " + "hot 7");
            mail.To.Add("amy.tsai@wowprime.com");
            mail.Subject = "hot 7加入會員失敗";
