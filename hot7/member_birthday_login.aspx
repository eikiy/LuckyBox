<%@ Page Language="C#" AutoEventWireup="true" CodeFile="member_birthday_login.aspx.cs" Inherits="member_birthday_login" %>
...
<div class="main">
  <div class="regbox" align="center">
    <table border="0" cellspacing="0" cellpadding="0"  class="tbl">
      <tbody>
        <tr>
          <td class="bg_line"><h4 class="form_tx flt_l"><i class="demo-icon c_blue">&#xe819;</i>會員登入-下載生日好禮</h4></td>
        </tr>
      </tbody>
    </table>
    <br>
...
<asp:TextBox ID="txtEmail" runat="server" CssClass="input_field"></asp:TextBox>
        ...
        <tr>
          ...
          <%--<input type="text" class="input_field">--%>
          <asp:TextBox ID="txtPwd" runat="server" MaxLength="8" TextMode="Password" CssClass="input_field"></asp:TextBox>
