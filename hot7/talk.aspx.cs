...
public partial class talk : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (email.Text == null || name.Text == null || store.SelectedValue == null || subject.Text == null || content.Text == null)
        {
            Response.Write("<script language=javascript>alert('欄位未填寫完整!!');location.href='talk.aspx';</script>");
            Response.End();
        }

        if (email.Text == "" || name.Text == "" || store.SelectedValue == "" || subject.Text == "" || content.Text == "")
        {
            Response.Write("<script language=javascript>alert('欄位未填寫完整!!');location.href='talk.aspx';</script>");
            Response.End();
        }
        ...
        if (res == 0)
        {
            ...
            Response.Write("<script language=javascript>alert('送出成功~感謝您!!');location.href='talk.aspx';</script>");
            Response.End();
        }
        else
        {
