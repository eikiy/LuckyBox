...
public partial class jp_menu : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            remark = dt.Rows[i]["remark_jp"].ToString();
            strHtml += "<tr>";
            strHtml += "<td class=\"x_f05\" style=\"text-align:center;\">" + dt.Rows[i]["name_jp"].ToString() + "</td>";
            strHtml += "</tr>";
            strHtml += " <tr>";
            strHtml += " <td class=\"x_f04a\" style=\"text-align:center;\">" + dt.Rows[i]["price_jp"].ToString() + "</td>";
            strHtml += "</tr>";
            strHtml += " <tr>";
            strHtml += "   <td class=\"x_line_y\"></td>";
            strHtml += " </tr>";
            strHtml += " <tr>";
            strHtml += " <td style=\"padding-right:30px; text-align:right;\"><a href=\"/menu.html\">中文</a>　<a href=\"/en/menu.aspx\">English</a></td>";
            strHtml += " </tr>";
        }
        ...
        for (int j = 0; j < dt2.Rows.Count; j++)
        {
            ...
            if (title != title_old)
            {
                ...
                strHtml += "<img src=\"../images/four/icn_01.png\" width=\"18\" height=\"25\"> " + dt2.Rows[j]["class_jp"].ToString() + "<br>";
                strHtml += "<span class=\"x_f07\">" + dt2.Rows[j]["Class_Remark_jp"].ToString() + "</span></td>";
                strHtml += "<td class=\"x_f06\" style=\"border-top:2px dotted #999;\">" + dt2.Rows[j]["MealName_jp"].ToString();
        ...
        if (dt.Rows[0]["remark_jp"].ToString() != "")
        {
