...
{
    #region 站台共用參數
    public static string strP_ShopNo = "115";
    public static string strP_Cname = "hot7";
    public static string strP_Ename = "hot7";
    public static string strP_Ename2 = "hot 7";
    public static string strP_Ename3 = "hot 7 新鉄板料理";
    public static string strP_WWW = "www.hot-7.com";
    public static string strP_EMail = "service@hot-7.com";
    public static string strP_0800 = "0800-295-777";
    #endregion
    ...
    public static void BindCity2Area(DropDownList ddl, string strCity)
    {
        ...
        sb.Append("<sql>");
        sb.Append("<select>");
        sb.Append("<list><![CDATA[select zip+area as name,zip from area where city=" + strCity + "]]>");
    ...
    public static void BindStore(DropDownList ddl, string strStoreNo)
    {
        ...
        sb.Append("<sql>");
        sb.Append("<select>");
        sb.Append(string.Format("<list><![CDATA[select StoreNo,StoreName from Cancer.wanggroup.dbo.Store_View where CareerNo='{0}' and StoreNo<>'{0}00' and OpenDate is not null   ORDER BY ZipCode ASC]]>", strStoreNo));
        sb.Append("</list>");
        sb.Append("</select>");
        sb.Append("</sql>");
        string sError = "";
