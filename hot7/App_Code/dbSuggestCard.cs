...
public class dbSuggestCard:DBBaseClass
{
    ...
    public DataSet Sel_Career(out string sReturnMsg)
    {
        ...
        try
        {
            ...
            sb.Append(@"SELECT Career,CareerName, CareerNo 
                        FROM Career ");
            sb.Append(@"WHERE CareerNo NOT IN('101','303') AND STOP='0' ");
   ...
   //事業處相關資料======================================================================
    ...
    public DataSet Sel_StoreView(string strStoreNo, out string sReturnMsg)
    {
        ...
        try
        {
            ...
            SDA_wanggroup.SelectCommand.Parameters.AddWithValue("@StoreNo", strStoreNo);//115
            SDA_wanggroup.SelectCommand.Parameters.AddWithValue("@StoreNo2", strStoreNo + "00");//11500
