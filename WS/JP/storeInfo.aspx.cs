...
public partial class en_storeInfo : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            strHtml += "\" alt=\"\" /></div><div class=\"txt right col-xs-12 col-sm-12 col-md-5 col-lg-5\"><h4>";
            strHtml += dt2.Rows[0]["store_name_jp"].ToString();
            strHtml += "</h4><dl class=\"dl-horizontal\"><dt>Address </dt><dd class=\"mpat\">";
            strHtml += dt2.Rows[0]["store_address_jp"].ToString();
            ...
            strHtml += dt2.Rows[0]["store_parking_info_jp"].ToString();
            strHtml += "</dd><dt>Features</dt><dd>";
            strHtml += dt2.Rows[0]["store_remark_jp"].ToString();
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            strHtml += "<div class=\"list-item clear auto\"><div class=\"view left jqimgFill\"><img src=\"";
            strHtml += dt2.Rows[0]["store_image"].ToString();
