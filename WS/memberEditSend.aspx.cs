...
public partial class memberEditSend : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                Response.Write("<script language=javascript>alert(\"資料錯誤!!\");location.replace('member.html');</script>");
                Response.End();
            }
            ...
            if (Request.QueryString["t"].ToString() == "2")
            {
                ...
                Label_name.Text = Session[CareerNo + "_name_s"].ToString();
            }
            else
            {
                ...
                //strHmtl += "  請至此 email 信箱確認成為 王品 的網路會員， 謝謝。</p>";
                ...
                //strHmtl += "撥打免付費意見專線 0800-071-198 為您處理。</FONT></li>";
