<%@ Page Language="C#" AutoEventWireup="true" CodeFile="success.aspx.cs" Inherits="e_member_application_success" %>
...
恭喜您成功申請『電子菁英禮讚本』<br/>
<p class="paragraph">您可以至領取電子優惠專區領取「9折+菁英禮」優惠券，</p></div>

<div class="box" style="padding-top:30px;">
<%--<a href="../coupon/coupon.htm" class="btn"><span>領取電子優惠券</span></a>--%>
    <asp:Button ID="Button1" runat="server" Text="領取電子優惠券" CssClass="btn" 
