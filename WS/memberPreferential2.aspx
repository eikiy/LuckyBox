<%@ Page Language="C#" AutoEventWireup="true" CodeFile="memberPreferential2.aspx.cs" Inherits="memberPreferential2" %>
        ...
        <div id="main" class="page-memberPreferential lineBk">
            <section class="section box1">
                <div class="container sm">
                    <div class="hd">
                        <h2 class="title  wow fadeInDown">結婚禮券兌換</h2>
                        <p><asp:Label ID="lblName2" runat="server" Text=""></asp:Label>
                          貴賓 您好：
                            <br> 王品祝您結婚快樂~
                            <br> 您可以列印此券，憑券至全台王品消費套餐，獨享結婚優惠禮遇。
                        </p>
                    </div>
                </div>
            </section>
            <section class="section box2 bg2">
                <div class="conpon" id="myDiv">
                    ...
                    <div class="txt">
                        <p>這是給
                        <asp:Label ID="lblName" runat="server" Text=""></asp:Label>的</p>
                        <h4><span>結婚禮券兌換</span></h4>
                        <p>&nbsp;</p>
                        <ul>
                    ...
                    <div class="pic">
                        <img src="styles/images/conpon-marry.jpg" alt="">
