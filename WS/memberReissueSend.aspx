<%@ Page Language="C#" AutoEventWireup="true" CodeFile="memberReissueSend.aspx.cs" Inherits="memberReissueSend" %>
        ...
        <div id="main" class="page-memberReissue lineBk">
            <section class="section box1 bg2">
                <div class="container sm">
                    <div class="hd">
                        <h2 class="title">補發確認信</h2>
                    </div>
                    <div class="info clear">
                        <form class="form" runat=server>
                            <p class="center">您的郵件已寄至您的信箱，請至您的信箱收取帳號資訊</p>
                            <div class="btnwp">
