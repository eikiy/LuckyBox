...
public partial class memberPreferentialLogin2 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        sError = wow.Wow_MemberLoginCheckMarry(CareerNo, txtEmail.Text.Trim(), txtPwd.Text.Trim(), out DS);
        //sError = m.MemberLoginCheckMarry(txtEmail.Text.Trim(), txtPwd.Text.Trim(), "taoban", out DS);
        if (sError != "")
        {
        ...
        Session["Marry"] = DS.Tables[0].Rows[0]["結婚紀念日"].ToString().Trim();
        this.Response.Redirect("memberPreferential2.aspx");
    }
    protected void Button2_Click(object sender, EventArgs e)
    {
        this.Response.Redirect("memberForget.aspx");
    }
}
