<%@ Page Language="C#" AutoEventWireup="true" CodeFile="memberEditSend.aspx.cs" Inherits="memberEditSend" %>
<!DOCTYPE html>
        ...
        <div id="main" class="page-memberForget lineBk">
            <section class="section box1">
                <div class="container sm">
                    <div class="hd">
                        <h2 class="title">完成會員資料修改</h2>
                    </div>
                    <div class="info clear">
                        <form class="form" runat=server>
                            <p class="center">
                              <asp:Label ID="Label_name" runat="server" Text="Label"></asp:Label> 貴賓 您好：
                                <br> 您的資料已修改完成，謝謝！
                            </p>
                            <div class="btnwp">
                                <%--<button type="submit" class="btn btn-primary">回會員中心
                                </button>--%>
                              <asp:Button ID="Button1" runat="server" Text="回會員中心" CssClass="btn btn-primary" 
