                ...
                if(data.data.message=='')
                {
                    if(issum==true)
                    {
                        ...
                        $.each(obj,function(index, el) {
                            if(moment(el.tradeDate).isAfter(moment(loadSessionStorage("expiretime")).subtract(366, 'days')) && moment(el.tradeDate).isBefore(moment(loadSessionStorage("expiretime"))))
                            {
